                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                            <h3 class="text-white">Organic Products</h3>
                            <h1 class="display-1 text-white mb-md-4">Empowering Rural Producers, Connecting You to the Source.</h1>
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    <div class="mb-3">
                        ...
                        <h1 class="display-5">Why you need to choose us ?</h1>
                    </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">123 Street, AP, India</p>
                            </div>
                            <div class="d-flex mb-2">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">+90 9848032919</p>
                            </div>
