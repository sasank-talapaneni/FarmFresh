...
<nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <button><a href="addproduct.html">Add Product</a></button>
			...
			%>
                <div class="pb-5">
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="product-image/<%=p.getImage() %>" alt="">
                        <h6 class="mb-3"><%=p.getName() %></h6>
                        <h6 class="mb-3">Category: <%=p.getCategory() %></h6>
                        <h5 class="text-primary mb-0">Price: Rs.<%=p.getPrice() %></h5>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn bg-primary py-2 px-3" href="add-to-cart?id=<%=p.getId()%>"><i class="bi bi-cart text-white"></i></a>
                            <a class="btn bg-secondary py-2 px-3" href="order-now?quantity=1&id=<%=p.getId()%>"><i class="bi bi-eye text-white"></i></a>
                        </div>
                    </div>
                </div>
